...
export function get(greeting, opt) {
   ...
   try {
      ...
      return replace_ex(text, opt)
   } catch(err) {
      return false
   }
}

export function replace_ex(greeting, opt) {
   opt = opt || 'origin'
